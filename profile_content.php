                        ...
                        <div class="col-lg-8 offset-2 text-left">
                            <form id="reg" name="reg" action="" method="GET">
                                ...
                                <div class="input-group mb-3" v-if="readonly">
                                    <img
                                        :src="`uploads/${(member.imgname)?member.imgname:'avatar.svg'}`"
                                        alt="photo"
                                        style="width:20%;"
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <button type="button"
                                        ...
                                        data-bs-target="#exampleModal">變更會員密碼</button>
                                    <button type="button"
                                        class="btn btn-primary btn-lg me-2 text-white"
                                        @click="saveMember"
                                        v-if="!readonly">儲存資料</button>
                                    <button type="button"
                                        class="btn btn-secondary btn-lg text-white"
                                        @click="readonly=true"
                                        v-if="!readonly">關閉</button>
                                </div>
                            </form>
                        </div>
                        <!-- Modal會員密碼變更模組 -->
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="exampleModalLabel">
                                            <i class="fas fa-user-lock me-2"></i>會員密碼變更頁面
                                        </h1>
