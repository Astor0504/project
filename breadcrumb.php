...
if (isset($_GET['p_id']) && $_GET['p_id']!=""){
    ...
    $level2Open='<li class="breadcrumb-item"><a herf="drugstore.php?classid'.$level2Classid.'">'.$level2Cname.'</a></li>';
    //處理第三層(產品名稱)
    $level3Open='<li class="breadcrumb-item active" aria-current="pagr">'.$data['p_name'].'</li>';
