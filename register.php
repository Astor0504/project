                    ...
                    <div class="row">
                        <div class="col-8 offset-2 text-left">
                            <form id="reg" name="reg" action="register.php" method="POST">
                                ...
                                <div class="input-group mb-3">
                                    <input type="file" name="fileToUpload" id="fileToUpload" class="form-control" title="請上傳相片區示" accept="image/x-png, image/jpeg, image/gif, image/jpg">
                                    <p>
                                    ...
                                    <div id="progress-div01" class="progress" style="width: 100%; display: none;">
                                        <div id="progress-bar01" class="progress-bar progress-bar-striped" role="progressbar" style="width: 0%" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">0%</div>
                                    </div>
...
<script type="text/javascript">
    ...
    $('#reg').validate({
        ...
        messages: {
            ...
            pw1: {
                required: '密碼不得為空白',
                maxlength: '密碼長度為20個字元(4-20位英文字母與數字的組合)',
                minlength: '密碼最小長度為4字元(4-20位英文字母與數字的組合)',
            },
            pw2: {
                required: '確認密碼不得為空白!',
                equalTo: '兩次數入的密碼必須一致',
