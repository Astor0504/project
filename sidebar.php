<div class="sidebar">
    <form name="search" id="search" action="drugstore.php" method="get">
        <div class="input-group">
            <input type="text" name="search_name" id="search_name" class="form-control" placeholder="Search..." value="<?php echo (isset($_GET['search_name'])) ? $_GET['search_name'] : ''; ?>" require>
    ...
    <?php while ($pyclass01_Rows = $pyclass01->fetch()) {
        ...
        <div class="accordion-item">
            ...
            if(isset($_GET['p_id'])){ //如果使用產品查詢,需取得類別編號上一層類別 
                ...
                $classid_rs = $link->query($SQLstring); $data = $classid_rs->fetch(); $ladder = $data['uplink' ];
